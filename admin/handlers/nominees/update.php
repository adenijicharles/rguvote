...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $video_file_name = $_POST['old_video'];
    $image_file_name = $_POST['old_picture'];
    ...
    $query = mysqli_query($connect, "UPDATE nominees SET name = '$name', student_id  = '$student_id', level = '$level', school = '$school', sex = '$sex', ethnicity = '$ethnicity', bio = '$bio', manifesto = '$video_file_name', position = '$position', picture = '$image_file_name' WHERE id = '$id'") or die(mysqli_error($connect));
    if($query) {
