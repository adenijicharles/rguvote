...
if($_POST) {
    check_for_empty_inputs($_POST, "newpassword.php?e=".$_POST['e']."&p=".$_POST['e']."&t=".$_POST['t']);
    
    $encrypted_email = $_POST['e'];
    $encrypted_password = $_POST['p'];
    ...
    $sql = "UPDATE voters SET password = '$password' WHERE md5(email) ='$encrypted_email'";
